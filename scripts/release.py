...
VERSION_FILE = REPO_ROOT / "kclaw_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "kclaw@nousresearch.com": "NousResearch",
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/kclaw",
    ...
    lines.append(f"# KClaw Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for KClaw Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="KClaw Agent Release Tool")
    ...
    if args.publish:
        ...
        gh_cmd = [
            ...
            "--title", f"KClaw Agent v{new_version} ({calver_date})",
