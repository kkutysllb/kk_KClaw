...
from kclaw_cli.config import get_kclaw_home, get_env_path, get_project_root, load_config
...
def run_dump(args):
    ...
    lines.append(f"kclaw_home:      {display_kclaw_home()}")
