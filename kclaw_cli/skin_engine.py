...
.. code-block:: yaml
    ...
    branding:
      agent_name: "KClaw Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ KClaw "       # Response box header label
...
.. code-block:: python
    ...
    from kclaw_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "KClaw Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.kclaw/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic KClaw gold/kawaii (the current look)
...
Drop a YAML file in ``~/.kclaw/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces KCLAW_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces KCLAW_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic KClaw — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "KClaw Agent",
            "welcome": "Welcome to KClaw Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ KClaw ",
            "prompt_symbol": "❯ ",
