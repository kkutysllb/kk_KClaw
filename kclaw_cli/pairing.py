...
Usage:
    kclaw pairing list              # Show all pending + approved users
    kclaw pairing approve <platform> <code>  # Approve a pairing code
    kclaw pairing revoke <platform> <user_id> # Revoke user access
    kclaw pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle kclaw pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: kclaw pairing {list|approve|revoke|clear-pending}")
        print("Run 'kclaw pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'kclaw pairing list' to see pending codes.\n")
