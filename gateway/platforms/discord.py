...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your KClaw session")
        ...
        @tree.command(name="status", description="Show KClaw session status")
        ...
        @tree.command(name="stop", description="Stop the running KClaw agent")
        ...
        @tree.command(name="update", description="Update KClaw Agent to the latest version")
        ...
        @tree.command(name="thread", description="Create a new thread and start a KClaw session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to KClaw in the thread",
        ...
        try:
            from kclaw_cli.commands import discord_skill_commands
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new KClaw session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by KClaw: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "KClaw"
        if len(content) > 80:
    ...
    async def send_update_prompt(
        ...
        Used by the gateway ``/update`` watcher when ``kclaw update --gateway``
    ...
    def _thread_state_path() -> Path:
        ...
        return get_kclaw_home() / "discord_threads.json"
...
if DISCORD_AVAILABLE:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``kclaw update`` prompts.
