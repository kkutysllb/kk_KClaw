"""
Email platform adapter for the KClaw gateway.

Allows users to interact with KClaw by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "KClaw Agent")
        ...
        msg_id = f"<kclaw-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
