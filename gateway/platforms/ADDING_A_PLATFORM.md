...
Checklist for integrating a new messaging platform into the KClaw gateway.
...
And add it to the `kclaw-gateway` composite:
...
## 12. Status Display (`kclaw_cli/status.py`)
...
## 13. Gateway Setup Wizard (`kclaw_cli/gateway.py`)
