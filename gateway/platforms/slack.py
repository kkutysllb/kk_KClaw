...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_kclaw_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/kclaw")
            async def handle_kclaw_command(ack, command):
                await ack()
            ...
            for _action_id in (
                "kclaw_approve_once",
                "kclaw_approve_session",
                "kclaw_approve_always",
                "kclaw_deny",
            ):
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "kclaw_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "kclaw_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "kclaw_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "kclaw_approve_once": "once",
            "kclaw_approve_session": "session",
            "kclaw_approve_always": "always",
            "kclaw_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from kclaw_cli.commands import slack_subcommand_map
