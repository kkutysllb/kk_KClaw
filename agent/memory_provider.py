...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - kclaw_home (str): The active KCLAW_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.kclaw``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "kclaw").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'kclaw memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], kclaw_home: str) -> None:
        ...
        Called by 'kclaw memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``kclaw_home`` is the active KCLAW_HOME directory path.
