...
Built for [KClaw Agent](https://github.com/NousResearch/kclaw). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/kclaw/skills/creative/ascii-video`](https://github.com/NousResearch/kclaw/tree/main/skills/creative/ascii-video) via PR.
