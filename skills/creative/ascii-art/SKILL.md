...
```bash
python3 -m pyfiglet "KCLAW" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=KCLAW&font=Slant" | boxes -d stone
```
