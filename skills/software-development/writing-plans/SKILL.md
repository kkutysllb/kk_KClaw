...
version: 1.1.0
author: KClaw Agent (adapted from obra/superpowers)
license: MIT
metadata:
  kclaw:
...
> **For KClaw:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use KClaw tools to understand the project:
