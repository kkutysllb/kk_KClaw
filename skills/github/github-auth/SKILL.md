...
- Give it a title like "kclaw-<machine-name>"
...
elif [ -f ~/.kclaw/.env ] && grep -q "^GITHUB_TOKEN=" ~/.kclaw/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.kclaw/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
