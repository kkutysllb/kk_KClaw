...
## KClaw Agent Integration

This skill is designed for the KClaw agent. It uses KClaw tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other KClaw skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.kclaw/plans/` | `skill_view("plan")` |
