...
metadata:
  kclaw:
    ...
    related_skills: [claude-code, kclaw]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the KClaw terminal. Codex is OpenAI's autonomous coding agent CLI.
