...
Data file: $KCLAW_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KCLAW_HOME = Path(os.environ.get("KCLAW_HOME", Path.home() / ".kclaw"))
DATA_DIR = _KCLAW_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
