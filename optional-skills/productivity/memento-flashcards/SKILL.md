...
```bash
python3 ~/.kclaw/skills/productivity/memento-flashcards/scripts/memento_cards.py due --collection "History"
```
...
```bash
python3 ~/.kclaw/skills/productivity/memento-flashcards/scripts/memento_cards.py stats
python3 ~/.kclaw/skills/productivity/memento-flashcards/scripts/memento_cards.py add --question "Capital of France?" --answer "Paris" --collection "General"
python3 ~/.kclaw/skills/productivity/memento-flashcards/scripts/memento_cards.py due
```
