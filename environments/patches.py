"""
Monkey patches for making kclaw tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by kclaw_base_env.py).
