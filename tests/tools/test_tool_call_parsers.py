...
class TestParserRegistry:
    ...
    def test_kclaw_parser_registered(self):
        parsers = list_parsers()
        assert "kclaw" in parsers
...
class TestKClawParser:
    @pytest.fixture
    def parser(self):
        return get_parser("kclaw")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["kclaw"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use kclaw format since that's universal
