...
class TestToolsetConsistency:
    ...
    def test_kclaw_platforms_share_core_tools(self):
        """All kclaw-* platform toolsets should have the same tools."""
        platforms = ["kclaw-cli", "kclaw-telegram", "kclaw-discord", "kclaw-whatsapp", "kclaw-slack", "kclaw-signal", "kclaw-homeassistant"]
