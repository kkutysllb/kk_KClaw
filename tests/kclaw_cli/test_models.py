"""Tests for the kclaw_cli models module."""
...
import kclaw_cli.models as _models_mod
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from kclaw_cli.models import _find_openrouter_slug
...
class TestCheckNousFreeTierCache:
    ...
    @patch("kclaw_cli.models.fetch_nous_account_tier")
    @patch("kclaw_cli.models.is_nous_free_tier", return_value=True)
    def test_result_is_cached(self, mock_is_free, mock_fetch):
        ...
        with patch("kclaw_cli.auth.get_provider_auth_state", return_value={"access_token": "tok"}), \
             patch("kclaw_cli.auth.resolve_nous_runtime_credentials"):
    ...
    @patch("kclaw_cli.models.fetch_nous_account_tier")
    @patch("kclaw_cli.models.is_nous_free_tier", return_value=False)
