...
title: "SMS (Twilio)"
description: "Set up KClaw Agent as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

KClaw connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back — same conversational experience as Telegram or Discord, but over standard text messages.
...
If you're running KClaw locally, use a tunnel to expose the webhook:
...
Text your Twilio number — KClaw will respond via SMS.
...
3. Check KClaw gateway logs for Twilio API errors
