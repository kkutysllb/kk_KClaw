...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to KClaw Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to KClaw Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
KClaw officially supports Linux, macOS, and WSL2. Native Windows is **not supported**, but the codebase includes some defensive coding patterns to avoid hard crashes in edge cases. Key rules:
...
KClaw has terminal access. Security matters.
...
2. **Test manually**: Run `kclaw` and exercise the code path you changed
