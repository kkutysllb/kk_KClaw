...
```bash
pip install git+https://github.com/kkutysllb/kk_KClaw.git
```

或使用 [uv](https://docs.astral.sh/uv/)：

```bash
uv pip install git+https://github.com/kkutysllb/kk_KClaw.git
```

您也可以在 `requirements.txt` 中固定它：

```text
kclaw @ git+https://github.com/kkutysllb/kk_KClaw.git
```
